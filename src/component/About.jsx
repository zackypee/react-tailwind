    ...
    return(
        <div className="flex flex-col px-4 sm:px-6 md:px-12 lg:px-20 max-w-7xl mx-auto mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 px-6   grid-rows-2 gap-8">
                <div className="row-span-2 flex justify-center md:justify-center"><img className="w-64 h-80 object-cover rounded-xl shadow-xl" src="/src/assets/profile-img.jpeg" alt=""/>
                </div>
